...
<div class="container zero-padding">
    ...
    <div class="span10 left-0 inner">
        <h3><?=date('l F d, Y', strtotime($main_video->publishdate)); ?></h3>
...
<div class="container zero-padding">
    ...
    <div class="span8  left-0 inner">
        ...
        <div class="inner-banner video-container">
            <iframe  src="https://www.youtube.com/embed/<?=$main_video->videoURL; ?>?version=3&vq=hd1080" frameborder="0" allowfullscreen></iframe>
            <h4><?=@$main_video->description; ?></h4>
        </div>
    </div>
        ...
        <ul class="sidebar">
           ...
           foreach ($related as $val){
               echo'<li>
                ...
                <div class="col-lg-8 col-xs-8 col-md-8"><a href="'.site_url('video/'.$val->id.'/'.$this->assist->slugify($val->title)).'">'.$val->title.'</a></div>
