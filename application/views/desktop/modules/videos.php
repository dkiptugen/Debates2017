    ...
    if ($x == 1) {
                    ...
                    <div class="container zero-padding">
                        ...
                        <div class="span1 social round">
                          ...
                          <ul class="shares xs-shares">
                              <li><h2>SHARE</h2></li>
                              <li><a href="https://www.facebook.com/sharer/sharer.php?u='.urlencode(current_url()).'" target="_blank"><img src="assets/img/facebook-inner.png" width="40" height="40" alt=""/></a></li>
                              <li><a href="https://www.twitter.com/intent/tweet?url='.urlencode(current_url()).'&via=debates_ke&text='.$value->title.'" target="_blank" ><img src="assets/img/twitter-share.png" width="40" height="40" alt=""/></a></li>
                              <li><img src="assets/img/youtube-inner.png" width="40" height="40" alt=""/></li>
                        ...
                        <div class="span8  left-0 inner">
                            ...
                            <div class="inner-banner">
                                <iframe style="width:100%; height: 400px;" src="https://www.youtube.com/embed/'.$value->videoURL.'?version=3&vq=hd1080" frameborder="0" allowfullscreen></iframe>
                            </div>
        ...
        echo '<li>
                ...
                <a href="'.site_url('video/'.$value->vid.'/'.$this->assist->slugify($value->title)).'" class="">
                    <img src="http://img.youtube.com/vi/'.$value->videoURL.'/2.jpg" class="img-responsive" width="150" height="150" alt=""/>
                </a>
                </div>
                <div class="span2 left-10">
