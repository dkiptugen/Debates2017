...
<div class="container zero-padding">
    ...
    <div class="span8  left-0">
        ...
        foreach ($others as $value)
            {
                $class=($j%2!=0)?'left-0':'';
                echo '<div class="span4 '.$class.'"><a href="'.site_url('article/'.$value->id.'/'.$this->assist->slugify($value->title)).'"> <img src="'.IMG_SRC.$value->thumbURL.'" class="img-responsive" alt=""/></a>
                        <div class="header">
    ...
    <div class="span4">
        <div class="side-advert">
            <img src="<?=base_url('assets/'); ?>img/advert.gif" width="300" height="250" alt=""/>
        </div>
